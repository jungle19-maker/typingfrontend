    ...
    return (
        <div style={{ padding: '3rem', maxWidth: '1000px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                <h1 style={{ color: 'var(--text-main)', marginBottom: '1rem', fontSize: '2.5rem' }}>Typing Curriculum</h1>
            ...
            <section style={{ marginBottom: '4rem', background: 'var(--bg-card)', padding: '2rem', borderRadius: '12px', boxShadow: '0 2px 10px rgba(0,0,0,0.05)' }}>
                <h3 style={{ color: 'var(--text-main)', marginBottom: '1rem', textAlign: 'center' }}>Finger Placement Guide</h3>
                <InstructionalUI />
            </section>

            <h2 style={{ marginBottom: '2rem', color: 'var(--text-main)', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '0.5rem' }}>Modules</h2>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.5rem' }}>
                {MODULES.map(module => (
                    <div key={module.id} className="module-card" style={{
                        ...
                        <div>
                            <h3 style={{ color: 'var(--text-main)', marginBottom: '0.5rem', fontSize: '1.2rem' }}>{module.title}</h3>
                            <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', margin: 0 }}>{module.description}</p>
                        </div>
                        <button
                            className="btn"
                            style={{
